---
name: gitea-oidc-config-safety
description: Use when changing configuration loading, defaults, Zod schemas, example gitea-oidc config files, JWKS handling, reverse proxy settings, production security warnings, or deployment-sensitive docs in this repository.
---

# Gitea OIDC Config Safety
